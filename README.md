...
## v0.19.9 – Deterministisches Festungs-Reveal

- das Ende der einmaligen Testfestungs-Enthüllung besitzt jetzt eine eigene deterministische Abschlussfunktion
- dieselbe Funktion wird sowohl vom normalen UI-Timer als auch vom Browser-Smoke verwendet
- die Release-Abnahme hängt damit nicht mehr davon ab, ob WebKit unter CI-Last einen kurzen Animations-Timer rechtzeitig ausführt
- die sichtbare Dauer für Kinder bleibt unverändert; geändert wurde nur die technische Abschlussgrenze
- keine Änderung an Festungszustand, Mastery, XP, Schaden oder Kampfergebnis
