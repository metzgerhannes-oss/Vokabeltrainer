...
function learnerAlreadyKnowsSense(learnerId,senseId){
  ...
  if(progress&&((progress.repetitions||0)>0||(progress.activePracticeDays||[]).length||(progress.activeSuccessDays||[]).length))return true;
