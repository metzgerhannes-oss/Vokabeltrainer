...
const HELP_TOPICS=Object.freeze({
  ...
  library:{title:'Vokabelbibliothek',text:'Die Bibliothek ist der gemeinsame, geprüfte Bestand. Im normalen Ablauf wählst du Lernstoff über „Lernstoff festlegen“ oder direkt beim Testplan; hier korrigierst und kontrollierst du nur den Bestand.'},
...
function openAppHelp(){
  ...
  if(parent){
    modal('<div class="eyebrow">Elternbereich</div><h2>Lernen vorbereiten & begleiten</h2><div class="help-overview"><div><strong>1 · Lernstoff</strong><span>Kind, Lehrwerk und konkrete Vokabeln auswählen. Bibliothek und technische Zuordnung laufen im Hintergrund.</span></div><div><strong>2 · Testplanung</strong><span>Termin und konkrete Testvokabeln festlegen. Daraus berechnet die App automatisch das Tagespensum.</span></div><div><strong>3 · Begleitung</strong><span>Fortschritt, Testchecks, Noten, Profile, LRS-Einstellungen, Lehrwerke und Sicherung liegen nur hier.</span></div></div><div class="modal-actions"><button value="ok" class="primary">Verstanden</button></div>');
    return;
  }
