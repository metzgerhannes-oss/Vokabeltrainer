...
const HELP_TOPICS=Object.freeze({
  ...
  library:{title:'Vokabelbibliothek',text:'Die Bibliothek ist der gemeinsame, geprüfte Bestand. Für einen anstehenden Test wählst du Wörter direkt unter „Test planen“. Ohne Testtermin nutzt du „Ohne Test lernen“. Hier korrigierst und kontrollierst du nur den Bestand.'},
...
function openAppHelp(){
  ...
  if(parent){
    modal('<div class="eyebrow">Elternbereich</div><h2>Lernen vorbereiten & begleiten</h2><div class="help-overview"><div><strong>1 · Test planen</strong><span>Steht ein Testtermin fest, wählst du dort direkt Termin und Vokabeln. Diese Wörter werden automatisch zum Lernstoff des Kindes.</span></div><div><strong>2 · Ohne Test lernen</strong><span>Nur wenn kein Testtermin feststeht, bereitest du hier zusätzlichen Lernstoff vor.</span></div><div><strong>3 · Begleitung</strong><span>Fortschritt, Testchecks, Noten, Profile, LRS-Einstellungen, Lehrwerke und Sicherung liegen nur hier.</span></div></div><div class="modal-actions"><button value="ok" class="primary">Verstanden</button></div>');
    return;
  }
