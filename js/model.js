...
function schoolYearWords(subject=state.activeSubject,schoolYear=currentSchoolYear()){return schoolYearVerifiedWords(subject,schoolYear).filter(wordFirstContactReady);}
