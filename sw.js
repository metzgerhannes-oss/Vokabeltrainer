...
const ASSETS=[
  './','./index.html','./css/app.css?v=0.18.22','./css/army.css?v=0.18.22','./js/core.js?v=0.18.22','./js/help.js?v=0.18.22','./js/library.js?v=0.18.22','./js/storage.js?v=0.18.22',
  './js/builtin-library.js?v=0.18.22','./js/model.js?v=0.18.22','./js/quiz-engine.js?v=0.18.22','./js/learning.js?v=0.18.22','./js/translation.js?v=0.18.22',
  './js/io.js?v=0.18.22','./js/family-sync.js?v=0.18.22',
  './js/device-pairing.js?v=0.18.22','./js/ui.js?v=0.18.22','./js/army-art.js?v=0.18.22','./js/army-ui.js?v=0.18.22','./js/library-ui.js?v=0.18.22','./js/focus-ui.js?v=0.18.22','./js/app.js?v=0.18.22','./manifest.webmanifest',
